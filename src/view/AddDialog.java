...
public class AddDialog extends MainFrame {
	...
	static JLabel[] labels = { new JLabel("ФИО"), new JLabel("Состав"), new JLabel("Позиция"), new JLabel("Титулы"),
			new JLabel("Вид спорта"), new JLabel("Разряд") };

	public static JTextField[] fields = { new JTextField(), new JTextField(), new JTextField(), new JTextField(),
