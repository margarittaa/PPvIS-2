...
public class MainFrame {
	...
	protected static String[] sportTitles = { "", "футбол", "баскетбол", "волейбол", "хоккей", "гандбол" };

	protected static String[] categoryTitles = { "", "1-й юношеский", "2-й разряд", "3й-разряд", "кмс",
			"мастер спорта" };
	...
	public static void CreateGUI() {
		...
		Component[] components = new Component[] { label, spinner, pageLabel, okButton, firstPageButton, lastPageButton,
				nextButton, previousButton, parseButton, addButton, searchButton, deleteButton, writeFileButton };
